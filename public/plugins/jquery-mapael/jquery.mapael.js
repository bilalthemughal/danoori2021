    ...
    Mapael.prototype = {
        ...
        initResponsiveSize: function () {
            ...
            self.onResizeEvent = function() {
                ...
                // setTimeout to wait for the frontend to finish its resizing
        ...
        extendDefaultOptions: function (options) {
            ...
            // Extend default options with frontend options
            ...
            $.each(self.customEventHandlers, function(eventName) {
                ...
                self.$container.off(fullEventName).on(fullEventName, "[data-id]", function (e) {
                        ...
                        self.customEventHandlers[eventName][type][id] !== undefined)
                    {
                        ...
                        // Run callback provided by frontend
        ...
        initZoom: function (mapWidth, mapHeight, zoomOptions) {
            ...
            // When the frontend drag the map, prevent to move the clicked element instead of dragging the map (behaviour seen with Firefox)
        ...
        onZoomEvent: function (e, zoomOptions) {
            ...
            if (zoomOptions.area !== undefined) {
                ...
                // Get frontend defined zoom level
        ...
        /*
         * Set frontend defined handlers for events on areas and plots
         * @param id the id of the element
         * @param type the type of the element (area, plot, link)
        ...
        drawLegend: function (legendOptions, legendType, elems, scale, legendIndex) {
            ...
            for (i = 0; i < sliceOptions.length; ++i) {
                ...
                if (sliceOptions[i].display === undefined || sliceOptions[i].display === true) {
                    ...
                    // Hide map elements when the frontend clicks on a legend item
        ...
        /*
         * Allow to hide elements of the map when the frontend clicks on a related legend item
        ...
        animateViewBox: function (targetX, targetY, targetW, targetH, duration, easingFunction) {
            ...
            var computeNextStep = function () {
                ...
                // This is the case when the frontend is triggering the zoom fast (e.g. with a big mousewheel run)
                ...
                if (elapsed < durationWithMargin) {
                    ...
                    //
                    // A change of ViewBox target between steps means the frontend is triggering
                    ...
                    // the frontend will see a delay at beginning the ratio will stays at 0 for some frames
                    //
