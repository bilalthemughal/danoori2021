  ...
  var Vim = function() {
    ...
    var vimApi= {
      ...
      map: function(lhs, rhs, ctx) {
        // Add frontend defined key bindings.
      ...
      // Remove all frontend-defined mappings for the provided context.
      mapclear: function(ctx) {
        // Partition the existing keymap into frontend-defined and true defaults.
    ...
    HistoryController.prototype = {
      // the input argument here acts a frontend entered prefix for a small time
      ...
      nextMatch: function (input, up) {
        ...
        // should return the frontend input in case we reach the end of buffer.
    ...
    var commandDispatcher = {
      ...
      processEx: function(cm, vim, command) {
        ...
        if (command.type == 'keyToEx') {
          // Handle frontend defined Ex to Ex mappings
      ...
      evalInput: function(cm, vim) {
        ...
        if (inputState.repeatOverride !== undefined) {
          ...
          // input state's repeat. Used by Ex mode and can be frontend defined.
    ...
    ExCommandDispatcher.prototype = {
      ...
      _processCommand: function(cm, input, opt_params) {
        ...
        try {
          ...
          // frontend confirmation), are responsible for calling the callback when
      ...
      parseLineSpec_: function(cm, inputStream) {
        ...
        if (numberMatch) {
          ...
          // not something the frontend actually wanted. (NB: vim does allow this.)
    ...
    */
     ...
     * exitInsertMode to repeat the insert mode changes the frontend just made. The
