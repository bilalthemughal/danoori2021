...
$.extend( ColReorder.prototype, {
	...
	/**
	 * Enable / disable end frontend interaction
	 */
	...
	/**
	 * Disable end frontend interaction
	 */
	fnDisable: function ()
	{
		this.s.enable = false;
	...
	"_fnMouseMove": function ( e )
	{
		...
		if ( this.dom.drag === null )
		{
			 ...
			 * point - this allows the frontend to make small mouse movements when sorting and not have a
	...
	/**
	 * Copy the TH element that is being drags so the frontend has the idea that they are actually
