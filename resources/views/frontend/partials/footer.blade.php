...
<footer class="bg-dark pt-5">
    <div class="container">
        ...
        <div class="row pb-2">
            ...
            <div class="col-md-4">
                ...
                <div class="col-md-6 mb-4">
                    <div class="mb-3">
                        <a class="btn-social bs-light bs-facebook ms-2 mb-2" target="__blank" href="https://www.facebook.com/danoori.pk">
                            <i class="ci-facebook"></i></a>
                        <a class="btn-social bs-light bs-instagram ms-2 mb-2" target="__blank" href="https://www.instagram.com/danoori.pk">
        ...
        <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">© All rights reserved. Made with <i
                class="ci-heart text-primary"></i> by <a class="text-light" href="https://createx.studio/"
                target="_blank" rel="noopener">Tech Notch</a></div>
    </div>
</footer>
