        ...
        <div class="row pb-2">
            ...
            <div class="col-md-4">
                ...
                <div class="col-md-6 mb-4">
                    <div class="mb-3"><a class="btn-social bs-light bs-twitter ms-2 mb-2" href="#"><i class="ci-twitter"></i></a><a class="btn-social bs-light bs-facebook ms-2 mb-2" href="#"><i class="ci-facebook"></i></a><a class="btn-social bs-light bs-instagram ms-2 mb-2" href="#"><i class="ci-instagram"></i></a></div>
                </div>
            </div>
        </div>
        <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">© All rights reserved. Made with <i class="ci-heart text-primary"></i> by <a class="text-light" href="https://createx.studio/" target="_blank" rel="noopener">Tech Notch</a></div>
    </div>
</footer>