                ...
                <div class="row d-lg-none">
                    <div class="col-lg-8">
                        <div class="d-flex pt-4 mt-3">
                            <div class="w-50 pe-3">
                                <a class="btn btn-secondary d-block w-100" href="/">
                                    <i class="ci-arrow-left mt-sm-0 me-1"></i>
                                    <span class="d-none d-sm-inline">Shop More</span>
                                    <span class="d-inline d-sm-none">Shop More</span>
                                </a>
                            </div>
                            <div class="w-50 ps-2">
                ...
                <div class="d-none d-lg-flex pt-4 mt-3">
                    <div class="w-50 pe-3">
                        <a class="btn btn-secondary d-block w-100" href="{{ route('cart') }}">
                            ...
                            <span class="d-inline d-sm-none">Continue Shopping</span>
                        </a>
                    </div>
                    <div class="w-50 ps-2">
