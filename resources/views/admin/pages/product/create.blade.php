        ...
        <div class="container-fluid">
            ...
            <form method="post" action="{{ route('admin.product.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input name="slug" required value="{{ old('slug') }}" type="text" class="form-control" id="slug"
                ...
                <div class="form-group">
                    ...
                    <input name="original_price" required value="{{ old('original_price') }}" type="text"
                ...
                <div class="form-group">
                    ...
                    <input name="image" required type="file" class="form-control" id="upload-image"
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input name="left_color" required value="{{ old('left_color') }}" type="text"
