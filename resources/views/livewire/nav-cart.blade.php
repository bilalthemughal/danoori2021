        ...
        <div class="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem;">
            <div style="height: 15rem;">
                ...
                <div class="widget-cart-item pb-2 border-bottom">
                    <button class="btn-close text-danger" wire:click.prevent="remove({{ $product['id'] }})" type="button" aria-label="Remove">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                ...
                <a class="btn btn-outline-secondary btn-sm" href="{{ route('cart') }}">Expand cart<i class="ci-arrow-right ms-1 me-n1"></i></a>
            </div>
